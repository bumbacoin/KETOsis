# Mac OS X KETOsisd Build Instructions
...
* See readme-qt.rst for instructions on building KETOsis QT, the
...
## Useful commands
    ...
    ./ketosisd --help  # for a list of command-line options.
    ./ketosisd -daemon # to start the ketosis daemon.
    ./ketosisd help    # When the daemon is running, to get a list of RPC commands
